...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <footer className="text-center px-4 sm:px-6 py-8 text-sm text-gray-500 border-t border-gray-200 dark:border-gray-800">
        <p>&copy; {new Date().getFullYear()} Pedro Henrique Garcia. All Rights Reserved.</p>
        <p>Crafted with cosmic energy, code, and a little help from AI.</p>
      </footer>
    </>
  );
};
